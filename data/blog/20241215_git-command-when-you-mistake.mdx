...
```zsh
git filter-branch -f --env-filter "GIT_AUTHOR_NAME='ajshooting'; GIT_AUTHOR_EMAIL='ajshooting.aj@gmail.com'; GIT_COMMITTER_NAME='ajshooting'; GIT_COMMITTER_EMAIL='ajshooting.aj@gmail.com';" HEAD
```
